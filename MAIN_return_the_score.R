...
curr_dataset = as.matrix(read.table(paste0(getwd(),"/dataset/file_",curr_dataset,".txt"),sep=",",header=FALSE,stringsAsFactors=FALSE))
...
# curr_solution = read.table(paste0(getwd(),"/curr_solution.txt"),header=F,stringsAsFactors=F)
...
curr_score = get.likelihood.score(dataset=curr_dataset,adj.matrix=curr_solution,regularizator="bic")
